...
Going forward: HealthNuts plans to improve this web app by implementing more features in the near future. With the nutritional data accessed and present in the app, there comes alot more opportunity to help people become nutritionally aware. One of the main features that needs to be complete is Goals/Challenges. Once it is, the dashboard on the home page will show a high level sub component of the current goals or challenges unique to the user. Utilizing the nutrient info, users will be able to create a goal based on their needs i.e want to eat more or less protein for the next 2 weeks. HealthNuts will have a long list of challenges and providing daily challenges like eat something that an elephant eats offers a fun approach to forming healthy eating habits. Displaying streaks is another essential feature that will be done at some point which will show each user patterns of what nutrients they consume most consistently so they can either maintain their eating habits or make the appropiate adjustments. In short, there is still work to be done but HealthNuts has paved a solid foundation for the future. With all this said, we hope you enjoy this revolutionary application because it is one of its kind.  
